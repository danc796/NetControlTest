...
class ConnectionManager:
    ...
    def auto_register_with_central_server(self, connection_id):
        ...
        try:
            ...
            # First register the server (this will automatically set recent_connection on the server)
            ...
            if success:
                ...
                # The server automatically sets recent_connection during registration,
                # but we still call set_sharing to ensure the sharing status is properly set
